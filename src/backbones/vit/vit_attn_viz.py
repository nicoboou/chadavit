...
__all__ = ['VisionTransformerAttnViz']  # model_registry will add each entrypoint fn to this
...
@torch.no_grad()
def _load_weights(model: VisionTransformerAttnViz, checkpoint_path: str, prefix: str = ''):
